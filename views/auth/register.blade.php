            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Gender') }}</label><br><br>

                            <div class="col-md-6">
                                <input type="radio" class="form-control @error('gender') is-invalid @enderror" name="gender" value="male" selected>Male
                                <input type="radio" class="form-control @error('gender') is-invalid @enderror" name="gender" value="female" selected>Female
                                <br><br>
